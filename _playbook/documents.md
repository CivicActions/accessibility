...
Visit [Creating Accessible Documents](../_guide/documents.md) in our [Guide](/guide) section.

## Checklist

* Check that the documents are accessible prior to allowing them to be posted to the website (ideally with a tool like the [CommonLook PDF Validator](https://commonlook.com/best-pdf-validator-is-free-for-everyone/))
* Track source files, so that additional improvements can be made, if barriers are identified
* Encourage teams to build documents in Word first
* Test documents with assistive technology
